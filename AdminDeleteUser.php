...
include '../Backend/Delete_User_Function.php';
...
<tr>
    ...
    <form action="" method="post">
        ...
        <input type="number" id="isAdmin" name="isAdmin" value="<?=$userInfo["isAdmin"]?>"><br>

        <label for="first_name">Name: </lable><br>
        <input type="text" id="first_name" name="first_name" value="<?=$userInfo["first_name"]?>"><br>

        <label for="surname">Surname: </lable><br>
        <input type="text" id="surname" name="surname" value="<?=$userInfo["surname"]?>"><br>

        <label for="password">Password: </lable><br>
        <input type="text" id="password" name="password" value="<?=$userInfo["password"]?>"><br>
        ...
        <input type="number" id="phone_number" name="phone_number" value="<?=$userInfo["phone_number"]?>"><br><br>
